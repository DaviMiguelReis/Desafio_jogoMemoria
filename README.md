...
3. Como foi criada a matriz gabarito
...
4. Como foi criada e inicializada a matriz visual
...
5. Como funciona a etapa de memorização inicial
...
6. Qual a função do Thread.Sleep e do Console.Clear
...
7. Como funcionam os contadores pares e tentativas
...
8. Como o laço while controla a continuidade do jogo
...
9. Como o jogador escolhe a primeira e a segunda carta
...
10. Como as cartas são reveladas no tabuleiro
...
11. Como o programa compara se as cartas formam um par
...
12. O que acontece quando o jogador acerta
...
13. O que acontece quando o jogador erra
...
14. Qual é a função do método ExibirTabuleiro
...
15. Como o jogo identifica que todos os pares foram encontrados
...
16. Como a mensagem final é exibida
...
17. Validação de linha e coluna
...
18. Impedimento de escolher a mesma carta duas vezes
...
19. Impedimento de escolher carta já encontrada
